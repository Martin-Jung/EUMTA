...
# Load overall
overall <- read.csv(paste0(path_output, "MTA_loglinear_EU_All_All_",version,".csv")) |> 
...
overall_art17 <- read_csv(
  paste0(path_output, 
         c(paste0("MTA_loglinear_EU_Art17_species_",version,".csv"),
           paste0("MTA_loglinear_EU_Art17_habitats_",version,".csv"))
         )
) |> dplyr::filter(option == "loglinear") 
